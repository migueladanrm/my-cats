...
export class InitialMigration1651616191879 implements MigrationInterface {
    name = 'InitialMigration1651616191879'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "cat" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(64) NOT NULL, "breed" character varying(64) NOT NULL, "description" character varying(300), "birthdate" date, "profile_picture" character varying(128), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "last_seen" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7704d5c2c0250e4256935ae31b4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cat_tracking" ADD CONSTRAINT "FK_d7955529bfb8d76679237b6132b" FOREIGN KEY ("cat_id") REFERENCES "cat"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
